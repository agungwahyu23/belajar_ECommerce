...
class Produk_model extends CI_Model{
    ...
    //detail variasi produk
    public function detail_variasi($id_var)
    {
        $this->db->select('*');
        $this->db->from('variasi');
        $this->db->where('id_var', $id_var);
        $this->db->order_by('id_var', 'desc');
        $query = $this->db->get();
        return $query->row();
    }
    ...
    //tambah variasi
    public function tambah_variasi($data_var)
    {
        $this->db->insert('variasi', $data_var);    
    }
    ...
    //delete variasi
    public function delete_variasi($data)
    {
        $this->db->query('UPDATE produk INNER JOIN variasi ON produk.id_produk = variasi.id_produk SET produk.stok=produk.stok-variasi.stok WHERE variasi.id_var= '.$data['id_var'].' ');
        $this->db->where('id_var', $data['id_var']);
        $this->db->delete('variasi', $data);
    }
}
