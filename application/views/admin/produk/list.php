...
<table class="table table-bordered" id="example1">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="<?= base_url('admin/produk/variasi/'.$produk->id_produk) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Variasi</a>
				...
				<a href="<?= $produk->url ?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-image"></i>URL</a>
