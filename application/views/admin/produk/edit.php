...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="text" name="url" class="form-control" placeholder="URL"
			value="<?php echo $produk->url ?>" required>
	</div>
</div>
<div class="form-group row">
...
<div class="form-group row">
	<label class="col-md-2 col-form-label control-label">Harga Beli Produk</label>
	<div class="col-md-5">
		<input type="text" name="harga_beli" class="form-control" placeholder="Harga produk"
			value="<?php echo $produk->harga_beli ?>" required>
	</div>
</div>
<div class="form-group row">
