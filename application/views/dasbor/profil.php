                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            placeholder="Nama Lengkap" value="<?php echo $pelanggan->nama_pelanggan
                            ?>" required></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            placeholder="Email" value="<?php echo $pelanggan->email
                            ?>" readonly></td>
                        </tr>
                        <tr>
                            <td>Password</td>
                        ...
                        <tr>
                            ...
                            placeholder="Telepon" value="<?php echo $pelanggan->telepon
                            ?>" required></td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
