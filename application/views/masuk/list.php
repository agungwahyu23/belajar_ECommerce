...
<p class="alert alert-succes">Belum memiliki akun? Silahkan <a href="<?php echo base_url('registrasi') 
?>" class="btn btn-info btn-sm">Registrasi Disini</a></p>
